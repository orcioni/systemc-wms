...
//
// Library of nonlinear silicon devices

// mosfet_1p (sc_core::sc_module_name name, double Vsat, double Isat)
// Mosfet one port, to be used as real switch; gate boolean port

// mosfet_2p (sc_core::sc_module_name name, double Vsat, double Isat)
// Mosfet series - two port in series between port1 and port2
// to be used as real switch; gate boolean port
...
// diode_1p (sc_core::sc_module_name name, double Vf, double If, double nVT)
// diode one port, to be used as a real rectifier
